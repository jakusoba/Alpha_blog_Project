...
describe "Blog application:" do
  describe "signup to the blog application" do
    it "confirm that a user can successfully signup" do
		 ...
		 #This creates an instance of the remote webdriver which indicates that test will run remotely. desired cabilities indicates the properties that i want to lunch the remote webdriver with e.g broswer name, version
